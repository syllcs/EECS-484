CREATE VIEW VIEW_USER_INFORMATION AS
	SELECT USERS.USER_ID, USERS.FIRST_NAME, USERS.LAST_NAME, USERS.YEAR_OF_BIRTH, USERS.MONTH_OF_BIRTH, USERS.DAY_OF_BIRTH, USERS.GENDER, C_CURRENT.CITY_NAME CURRENT_CITY, C_CURRENT.STATE_NAME CURRENT_STATE, C_CURRENT.COUNTRY_NAME CURRENT_COUNTRY, C_HOMETOWN.CITY_NAME, C_HOMETOWN.STATE_NAME, C_HOMETOWN.COUNTRY_NAME, PROGRAMS.INSTITUTION, EDUCATION.PROGRAM_YEAR, PROGRAMS.CONCENTRATION, PROGRAMS.DEGREE
	FROM USERS
	LEFT JOIN USER_CURRENT_CITIES ON USERS.USER_ID=USER_CURRENT_CITIES.USER_ID
	LEFT JOIN CITIES C_CURRENT ON USER_CURRENT_CITIES.CURRENT_CITY_ID=C_CURRENT.CITY_ID
	LEFT JOIN USER_HOMETOWN_CITIES ON USERS.USER_ID=USER_HOMETOWN_CITIES.USER_ID
	LEFT JOIN CITIES C_HOMETOWN ON USER_HOMETOWN_CITIES.HOMETOWN_CITY_ID=C_HOMETOWN.CITY_ID 
...
CREATE VIEW VIEW_PHOTO_INFORMATION AS
	SELECT PHOTOS.ALBUM_ID, ALBUMS.ALBUM_OWNER_ID, ALBUMS.COVER_PHOTO_ID, ALBUMS.ALBUM_NAME, ALBUMS.ALBUM_CREATED_TIME, ALBUMS.ALBUM_MODIFIED_TIME, ALBUMS.ALBUM_LINK, ALBUMS.ALBUM_VISIBILITY, PHOTOS.PHOTO_ID,PHOTOS.PHOTO_CAPTION, PHOTOS.PHOTO_CREATED_TIME, PHOTOS.PHOTO_MODIFIED_TIME, PHOTOS.PHOTO_LINK
	FROM PHOTOS
